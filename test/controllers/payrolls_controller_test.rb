...
class PayrollsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payroll" do
    assert_difference("Payroll.count") do
      post payrolls_url, params: { payroll: { name: @payroll.name, reconciled: @payroll.reconciled, submitted: @payroll.submitted, week_ending: @payroll.week_ending } }
    end
  ...
  test "should update payroll" do
    patch payroll_url(@payroll), params: { payroll: { name: @payroll.name, reconciled: @payroll.reconciled, submitted: @payroll.submitted, week_ending: @payroll.week_ending } }
